 ...
 *   Production: npx tsx scripts/check-console-errors.ts https://raul-alvarez.es
 *
...
function getUrls(): string[] {
  ...
  urls.push('https://raul-alvarez.es/privacidad', 'https://raul-alvarez.es/privacy')

  // Convert to use the base URL
  return urls.map(url => url.replace('https://raul-alvarez.es', baseUrl))
}
