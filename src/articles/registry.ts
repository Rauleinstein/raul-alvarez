...
export const articleRegistry: ArticleConfig[] = [
  {
    ...
    seo: {
      es: {
        ...
        description:
          'Caso técnico: Custodio Digital (spin-off Aircury), RBAC, multisig, trazabilidad y rol de CTO. Granada / remoto.',
      },
      en: {
        title: 'Custodio Digital — institutional digital asset custody | Raúl Álvarez',
        description:
          'Case study: Custodio Digital (Aircury spin-off), RBAC, multisig, traceability, and CTO role. Granada / remote.',
      },
    },
    sectionLabels: { es: {}, en: {} },
    type: 'case-study',
    ...
    seoMeta: {
      ...
      articleTags: 'custody,security,Aircury,Granada,RBAC',
      images: [OG],
      about: [
  ...
  },
  {
    ...
    seo: {
      es: {
        title: 'PowerMark — IA OCR+NLP para evaluación educativa (Aircury) | Raúl Álvarez',
        description:
          'PowerMark: corrección asistida por IA integrada con Smartgrade; OCR, PLN y despliegue en aulas.',
      },
      en: {
        title: 'PowerMark — AI OCR+NLP grading (Aircury) | Raúl Álvarez',
        description:
          'PowerMark: AI-assisted grading integrated with Smartgrade; OCR, NLP, and classroom rollout.',
      },
    },
    sectionLabels: { es: {}, en: {} },
    type: 'case-study',
    ...
    seoMeta: {
      ...
      articleType: 'TechArticle',
      articleTags: 'OCR,NLP,EdTech,Smartgrade,Aircury',
      images: [OG],
      about: [
        { '@type': 'SoftwareApplication', name: 'Smartgrade', url: 'https://www.smartgrade.com' },
        { '@type': 'Thing', name: 'Educational assessment AI' },
      ],
      citation: [{ '@type': 'WebSite', name: 'Smartgrade', url: 'https://www.smartgrade.com' }],
      mentions: [
        { '@type': 'Organization', name: 'Aircury', url: 'https://www.aircury.com' },
